...
<script src="js/clx/clx-about.js"></script>
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=LQVmrAfmIM8iaCsNEdmmUUbl"></script>
<!--[if lt IE 9]>
...
<body>
  <div class="wrap">
    <header>
      ...
      <!-- 标记当前页面的url -->
      <input id="pageMark" type="hidden" value="aboutController/initAbout" />
      <div class="clx-staticImg-box clx-box-mid" style="background: url('./img/about.jpg') no-repeat" id="clxImgBox"></div>
    </header>
    <article class="clx-common-article clx-box-mid">
      <div class="clx-common-article-box">
        <div>
          <h4 class="clx-article-fontColor clx-font-xl clx-font-bold">公司简介</h4>
        </div>
      </div>
      <div class="clx-common-article-box text-indent">
        <div class="clx-content-box clx-box-mid">
          <p class="clx-SYfont-famliy clx-font-m clx-article-fontColor">大连九江泰科技有限公司，主要从事智能硬件和网络产品开发及应用。储留箱是大连九江泰科技有限公司
            为物业公司、社区业主及快递公司打造的新型智能快递终端，为社区居民提供智能代取快递、个人便民业务等 一系列综合服务。智能快递终端是一个基于物联网的，能够将物品进行识别，暂存，监控和管理的互动式大终端， 并通过PC服务器对本系统的各个快递终端进行统一化管理。</p>
          <div class="clx-map-box clx-box-mid" id="allmap"></div>
          <div class="clx-map-contral clx-box-mid">
            <div class="clx-fl">
              从&nbsp;&nbsp;
              <input id="start" type="text" style="width: 200px;" />
              &nbsp;&nbsp;到&nbsp;&nbsp;公司&nbsp;&nbsp;
            </div>
            <div class="clx-fl">
              <input class="btn" id="go" type="button" value="GO" />
            </div>
      ...
      <div class="clx-footer-finshed">
        ...
        <div class="clx-friend-href clx-box-mid">
          <ul class="clx-box-mid">
            ...
            <li>
              <a href="http://m.kuaidi100.com" target="_blank">百度地图</a>
            </li>
            <li>

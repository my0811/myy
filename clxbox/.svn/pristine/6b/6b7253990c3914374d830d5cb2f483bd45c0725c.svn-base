...
<script src="js/clx/clx-joinIn.js"></script>
...
<body>
  <div class="wrap">
    <header>
      ...
      <!-- 标记当前页面的url -->
      <input id="pageMark" type="hidden" value="joinInController/initJoinIn" />
      <div class="clx-staticImg-box clx-box-mid" style="background: url('img/clx_join_us.jpg')"></div>
    </header>
    <article class="clx-common-article clx-box-mid">
      <div class="clx-common-article-box">
        <div>
          <h4 class="clx-font-bold clx-article-fontColor clx-font-m clx-fl">职位列表</h4>
          <span class="clx-fl clx-article-fontColor clx-font-xs">
            请您将简历投递致 :
            <a class="clx-focus-fontColor clx-email" href="mailTo:clx@clxbox.com">clx@clxbox.com</a>
          </span>
          <div class="clx-clear"></div>
        </div>
      </div>
      <div class="clx-common-article-box" id="clxList"></div>
      <!--popup-->
      <div class="m-layer z-display" id="popup"></div>
    </article>
    <footer>
